      ...
      <nav className="sidebar-nav">
        ...
        {isAdmin && (
          <>
            ...
            <NavLink to="/admin/program-managers" className={({ isActive }) => `nav-item${isActive ? ' active' : ''}`}>
              <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            ...
            <a href="https://kcr.cetu.online" target="_blank" rel="noopener noreferrer" className="nav-item">
              <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
