'use strict';
/**
 * Definitions for PACKET HEIST v2 Drop 1's per-victim assessments: 7
 * individual role assessments plus 1 squad quiz per victim. Pure data — no
 * database access — so seed-pact-day1-victim-roles.js and its tests share it.
 */
