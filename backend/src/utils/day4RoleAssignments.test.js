...
const { buildAssignmentSpecs, ROLES } = require('../../scripts/lib/day4RoleSpecs');
...
test('Day 4 is cohort-wide: exactly 7 individual role assessments plus 1 squad synthesis quiz, none victim-scoped', () => {
